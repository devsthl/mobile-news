...
import { Pixel10, Pixel16, Pixel20, Pixel8, Pixel80 } from '../../Utils/Transform'
...
function PhoneBook(props: Props) {
    ...
    const renderItem = (item: any) => {
        return (
            <TouchableOpacity
                ...
                onPress={() => navigation.navigate('PhonebookDetail',
                    {
                        name: item.name,
                        id: item.id,
                        item: item
                ...
                <View style={styles.infoContact}>
                    <AppText
                        style={[styles.nameContact, { color: NewColor[themes].text.normal }]}
                    >
                        {item.name}
                    </AppText>
                </View>
